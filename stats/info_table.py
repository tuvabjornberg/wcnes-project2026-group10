...
files = {
    "50cm": "./opt1/opt1-50cm.csv",
    "100cm": "./opt1/opt1-100cm.csv",
    "150cm": "./opt1/opt1-150cm.csv",
    "200cm": "./opt1/opt1-200cm.csv",
    "250cm": "./opt1/opt1-250cm.csv",
}
...
for ax, (dist, filename) in zip(axes, files.items()):
    ...
    df.seq = np.unwrap(df.seq, discont=150 if dist != "50cm" else 165, period=256)
    df = df[df.payload.apply(lambda x: len(x) == ((26) * 3 - 1))]
