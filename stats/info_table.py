...
files = [
    ("base   3m", "./baseline-exp4-range/baseline4-range-r3m.csv"),
    ("base   4m", "./baseline-exp4-range/baseline4-range-r4m.csv"),
    ("base   5m", "./baseline-exp4-range/baseline4-range-r5m.csv"),
    ("base 5.5m", "./baseline-exp4-range/baseline4-range-r5.5m.csv"),
    ("opt    3m", "./opt2-range/opt2-range-r3m.csv"),
    ("opt    4m", "./opt2-range/opt2-range-r4m.csv"),
    ("opt    5m", "./opt2-range/opt2-range-r5m.csv"),
]
